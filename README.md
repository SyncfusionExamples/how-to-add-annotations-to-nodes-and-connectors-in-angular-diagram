...
A quick start Angular project that shows how to add annotations to nodes and connectors in an [Angular Diagram](https://www.syncfusion.com/diagram-sdk/angular-diagram). This project includes a code snippet to add an annotation programmatically and customization options like horizontal alignment, vertical alignment, offset, and text wrapping.
